...
export class SamplePoThemeLabsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    protected thfTheme: ThfThemeService,
  ) {
    const _poTheme = this.poTheme.applyTheme();
    this.a11yLevel = this.poTheme.getA11yLevel();

    if (!_poTheme) {
      this.thfTheme.setTheme(this.poThemeSample, this.theme, this.a11yLevel);
  ...
  changeTheme(value: number, dispatchEvent = true) {
    this.thfTheme.setTheme(this.poThemeSample, value, this.a11yLevel);
    value === 1

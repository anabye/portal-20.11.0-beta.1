...
`),t()()()()(),n(21,"div",10),l(22,"sample-po-button-labs"),t(),l(23,"hr")),a&2&&(s(5),_("po-icon "+i.sampleCodeButtonIcon),s(),g(" ",i.sampleCodeButtonLabel,""),s(),m("ngClass",B(4,ve,i.hideSampleCodeTabs)))},dependencies:[T,k,v,C,se],encapsulation:2})}return o})();function ke(o,Se){if(o&1){let r=L();n(0,"div",0),l(1,"po-avatar",2),n(2,"div",3)(3,"span",4),e(4),t(),n(5,"span",5),e(6),t(),n(7,"span",5),e(8),t()()(),n(9,"div",0)(10,"po-button",6),p("p-click",function(){u(r);let i=M();return b(i.notification("added","success"))}),t(),n(11,"po-button",7),p("p-click",function(){u(r);let i=M();return b(i.notification("ignored","warning"))}),t(),n(12,"po-button",8),p("p-click",function(){u(r);let i=M();return b(i.notification("blocked","information"))}),t()()}if(o&2){let r=M();s(),m("p-src",r.userAvatar),s(3),g(" ",r.currentFriend.name," "),s(2),g(" ",r.currentFriend.mutualFriends," mutual friends "),s(2),g(" Resides in ",r.currentFriend.reside," ")}}function ye(o,Se){o&1&&(n(0,"div",0)(1,"span",9),e(2,"Congratulations TOTVS, no more requests!"),t()())}var me=(()=>{class o{poNotification=V(te);currentFriend;userAvatar="https://lorempixel.com/144/144/";newFriends=[{name:"Mr. Dev PO",mutualFriends:"7",reside:"Mountain View, CA"},{name:"Mr. AI PO",mutualFriends:"99+",reside:"New York City, NY"},{name:"Mr. UX PO",mutualFriends:"14",reside:"Los Angeles, CA"}];indexFriend=0;ngOnInit(){this.setCurrentFriend(0)}notification(r,a){this.poNotification[a](`User ${r} successfully!`),this.indexFriend++,this.setCurrentFriend(this.indexFriend)}setCurrentFriend(r){this.currentFriend=this.newFriends[r]}static \u0275fac=function(a){return new(a||o)};static \u0275cmp=E({type:o,selectors:[["sample-po-button-social-network"]],standalone:!1,decls:4,vars:1,consts:[[1,"po-row"],["p-title","Friend Request",1,"po-lg-6"],["p-size","lg",1,"po-md-4",3,"p-src"],[1,"po-md-8"],[1,"po-sm-12","po-font-subtitle"],[1,"po-sm-12","po-font-text"],["p-icon","fa fa-check-circle","p-label","Confirm",1,"po-md-4",3,"p-click"],["p-icon","fa fa-eye-slash","p-label","Ignore",1,"po-md-4",3,"p-click"],["p-icon","fa fa-ban","p-label","Block",1,"po-md-4",3,"p-click"],[1,"po-lg-8","po-font-subtitle"]],template:function(a,i){a&1&&(n(0,"div",0)(1,"po-widget",1),W(2,ke,13,4)(3,ye,3,0,"div",0),t()()),a&2&&(s(2),R(i.currentFriend?2:3))},dependencies:[J,D,oe],encapsulation:2})}return o})();var Pe=o=>({"docs-sample-code-tabs":o}),ce=(()=>{class o{hideSampleCodeTabs=!0;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus"}static \u0275fac=function(a){return new(a||o)};static \u0275cmp=E({type:o,selectors:[["sample-po-button-social-network-view"]],standalone:!1,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(a,i){a&1&&(l(0,"br"),n(1,"blockquote",0)(2,"label",1),e(3,"PO Button Social Network"),t(),n(4,"a",2),p("click",function(){return i.toggleSampleCodeTabs()}),l(5,"span"),e(6),t()(),n(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),e(12,"sample-po-button-social-network/sample-po-button-social-network.component.html"),t(),n(13,"pre",7),e(14,`<div class="po-row">

...
`),e()()()()(),t(21,"div",10),p(22,"sample-po-tooltip-labs"),e(),p(23,"hr")),a&2&&(r(5),P("po-icon "+i.sampleCodeButtonIcon),r(),y(" ",i.sampleCodeButtonLabel,""),r(),d("ngClass",_(4,Ce,i.hideSampleCodeTabs)))},dependencies:[x,T,E,v,le],encapsulation:2})}return n})();var we=["formNewUser"],re=(()=>{class n{poNotification;formNewUser;birthDate;confirmPassword;CPF;email;emailTooltip;genre;name;nameTooltip;password;passwordTooltip;registration;registrationTooltip;constructor(s){this.poNotification=s}ngOnInit(){this.initialize()}cancel(){this.formNewUser.reset()}confirm(){this.formNewUser.valid?(this.poNotification.success("New user registered"),this.cancel()):this.poNotification.error("Please fill in the required fields")}initialize(){this.emailTooltip="your_account@po-ui.com",this.nameTooltip="Enter full name",this.passwordTooltip="Password must contain at least 8 characters",this.registrationTooltip="The registration number is on the registration form"}static \u0275fac=function(a){return new(a||n)(D(Y))};static \u0275cmp=c({type:n,selectors:[["sample-po-tooltip-new-user"]],viewQuery:function(a,i){if(a&1&&z(we,7),a&2){let m;A(m=j())&&(i.formNewUser=m.first)}},standalone:!1,decls:16,vars:13,consts:[["formNewUser","ngForm"],[1,"po-row"],["p-primary-label","Cancel","p-secondary-label","Confirm","p-title","Register New User",1,"po-md-12",3,"p-primary-action","p-secondary-action"],["name","registration","p-clean","","p-label","Registration","p-mask","99999-99/99","p-minlength","11","p-required","",1,"po-md-6",3,"ngModelChange","ngModel","p-tooltip"],["name","email","p-clean","","p-label","Email","p-pattern","@po-ui.com","p-required","",1,"po-md-6",3,"ngModelChange","ngModel","p-tooltip"],["name","name","p-clean","","p-label","Name","p-required","",1,"po-md-6",3,"ngModelChange","ngModel","p-tooltip"],["name","CPF","p-clean","","p-label","CPF","p-mask","999.999.999-99","p-minlength","14","p-required","",1,"po-md-6",3,"ngModelChange","ngModel"],["name","birthDate","p-clean","","p-label","Birth Date",1,"po-md-6",3,"ngModelChange","ngModel"],["name","genre","p-clean","","p-label","Genre",1,"po-md-6",3,"ngModelChange","ngModel"],["name","password","p-clean","","p-label","Password","p-minlength","8","p-required","",1,"po-md-6",3,"ngModelChange","ngModel","p-tooltip"],["name","confirmPassword","p-clean","","p-label","Confirm Password","p-required","",1,"po-md-6",3,"ngModelChange","ngModel","p-pattern"]],template:function(a,i){if(a&1){let m=V();t(0,"div",1)(1,"po-widget",2),f("p-primary-action",function(){return u(m),g(i.cancel())})("p-secondary-action",function(){return u(m),g(i.confirm())}),t(2,"form",null,0)(4,"div",1)(5,"po-input",3),S("ngModelChange",function(l){return u(m),C(i.registration,l)||(i.registration=l),g(l)}),e(),t(6,"po-email",4),S("ngModelChange",function(l){return u(m),C(i.email,l)||(i.email=l),g(l)}),e()(),t(7,"div",1)(8,"po-input",5),S("ngModelChange",function(l){return u(m),C(i.name,l)||(i.name=l),g(l)}),e(),t(9,"po-input",6),S("ngModelChange",function(l){return u(m),C(i.CPF,l)||(i.CPF=l),g(l)}),e()(),t(10,"div",1)(11,"po-datepicker",7),S("ngModelChange",function(l){return u(m),C(i.birthDate,l)||(i.birthDate=l),g(l)}),e(),t(12,"po-input",8),S("ngModelChange",function(l){return u(m),C(i.genre,l)||(i.genre=l),g(l)}),e()(),t(13,"div",1)(14,"po-password",9),S("ngModelChange",function(l){return u(m),C(i.password,l)||(i.password=l),g(l)}),e(),t(15,"po-password",10),S("ngModelChange",function(l){return u(m),C(i.confirmPassword,l)||(i.confirmPassword=l),g(l)}),e()()()()()}a&2&&(r(5),h("ngModel",i.registration),d("p-tooltip",i.registrationTooltip),r(),h("ngModel",i.email),d("p-tooltip",i.emailTooltip),r(2),h("ngModel",i.name),d("p-tooltip",i.nameTooltip),r(),h("ngModel",i.CPF),r(2),h("ngModel",i.birthDate),r(),h("ngModel",i.genre),r(2),h("ngModel",i.password),d("p-tooltip",i.passwordTooltip),r(),h("ngModel",i.confirmPassword),d("p-pattern",i.password))},dependencies:[W,L,q,U,F,X,Z,O,$,te,M],encapsulation:2})}return n})();var ve=n=>({"docs-sample-code-tabs":n}),se=(()=>{class n{hideSampleCodeTabs=!0;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus"}static \u0275fac=function(a){return new(a||n)};static \u0275cmp=c({type:n,selectors:[["sample-po-tooltip-new-user-view"]],standalone:!1,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(a,i){a&1&&(p(0,"br"),t(1,"blockquote",0)(2,"label",1),o(3,"PO Tooltip - New User"),e(),t(4,"a",2),f("click",function(){return i.toggleSampleCodeTabs()}),p(5,"span"),o(6),e()(),t(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),o(12,"sample-po-tooltip-new-user/sample-po-tooltip-new-user.component.html"),e(),t(13,"pre",7),o(14,`<div class="po-row">
  <po-widget
    class="po-md-12"

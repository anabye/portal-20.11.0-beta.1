...
`),n()()()()(),e(21,"div",10),a(22,"sample-po-badge-labs"),n(),a(23,"hr")),l&2&&(r(5),B("po-icon "+o.sampleCodeButtonIcon),r(),f(" ",o.sampleCodeButtonLabel,""),r(),d("ngClass",_(4,ve,o.hideSampleCodeTabs)))},dependencies:[y,E,v,C,pe],encapsulation:2})}return i})();function Ee(i,ge){if(i&1&&(e(0,"div",1)(1,"po-container")(2,"div",2),z(),e(3,"svg",3),a(4,"circle",4)(5,"path",5),n(),I(),e(6,"p",6),t(7),a(8,"po-badge",7),n()()()()),i&2){let p=ge.$implicit;r(3),W("kind",p.status),r(4),f(" ",p.nome," "),r(),d("p-status",p.status==="online"?"positive":"negative")}}var re=(()=>{class i{users=[{nome:"Leonardo da vinci",status:"online"},{nome:"Johann Pachelbel",status:"offline"},{nome:"Amadeus Mozart",status:"offline"}];static \u0275fac=function(l){return new(l||i)};static \u0275cmp=m({type:i,selectors:[["sample-po-badge-message"]],standalone:!1,decls:4,vars:0,consts:[[1,"po-row","po-mt-3"],[1,"po-mb-1"],[1,"card"],["stroke-linecap","round","stroke-linejoin","round",1,"po-mr-2"],["cx","12","cy","12","r","11"],["d","m8 13 2.165 2.165a1 1 0 0 0 1.521-.126L16 9","fill","none"],[1,"po-mr-2","card-name-user","po-text-color-neutral-dark-40"],[1,"po-badge-wrap",3,"p-status"]],template:function(l,o){l&1&&(e(0,"div",0)(1,"div"),F(2,Ee,9,3,"div",1,N),n()()),l&2&&(r(2),H(o.users))},dependencies:[Y,M],styles:[".po-badge-wrap[_ngcontent-%COMP%]{position:absolute;top:-5px;right:-5px}svg[_ngcontent-%COMP%]{width:1.5rem;height:1.5rem;flex:none;stroke-width:2;stroke-linecap:round}svg[kind=online][_ngcontent-%COMP%]{stroke:#0ea5e9;fill:#e0f2fe}svg[kind=offline][_ngcontent-%COMP%]{fill:#fff;stroke:#dc2626}.card[_ngcontent-%COMP%]{display:flex;align-items:center;position:relative}"]})}return i})();var we=i=>({"docs-sample-code-tabs":i}),de=(()=>{class i{hideSampleCodeTabs=!0;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus"}static \u0275fac=function(l){return new(l||i)};static \u0275cmp=m({type:i,selectors:[["sample-po-badge-message-view"]],standalone:!1,decls:30,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],["p-label","CSS"],["appCodeHighlight","",1,"css"],[1,"docs-sample-container"]],template:function(l,o){l&1&&(a(0,"br"),e(1,"blockquote",0)(2,"label",1),t(3,"PO Badge Message"),n(),e(4,"a",2),u("click",function(){return o.toggleSampleCodeTabs()}),a(5,"span"),t(6),n()(),e(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),t(12,"sample-po-badge-message/sample-po-badge-message.component.html"),n(),e(13,"pre",7),t(14,`<div class="po-row po-mt-3">
  <div>

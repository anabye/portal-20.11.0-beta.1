...
`),e()()()()(),o(21,"div",10),r(22,"sample-po-accordion-basic"),e(),r(23,"hr")),i&2&&(d(5),A("po-icon "+a.sampleCodeButtonIcon),d(),f(" ",a.sampleCodeButtonLabel,""),d(),c("ngClass",w(4,he,a.hideSampleCodeTabs)))},dependencies:[y,C,E,x,ne],encapsulation:2})}return n})();function ge(n,V){if(n&1&&(o(0,"po-accordion-item",2),t(1),e()),n&2){let l=V.$implicit,i=V.$index;c("p-label",l.label)("p-disabled",l.disabledItem)("p-label-tag",l.labelTag)("p-type-tag",l.typeTag),d(),f(" Accordion Item Content ",i," ")}}var re=(()=>{class n{accordionFieldsForm=[{property:"label",required:!0,gridColumns:6},{property:"labelTag",label:"Label Tag",gridColumns:6}];propertiesAccordionOptions=[{value:"showManager",label:"Show Accordion Manager"},{value:"expandItems",label:"Allow Expand All Items"}];typeTagOptions=[{value:"success",label:"Success"},{value:"warning",label:"Warning"},{value:"danger",label:"Danger"},{value:"info",label:"Info"}];disabledOption=[{value:"disabled",label:"Disabled"}];properties=[];propertiesAccordion=[];disabledItem=[];accordionItemIndex;customLiterals;literals;typeTag;accordionItems=[];ngOnInit(){this.restore()}addAccordionItem(l){l.disabledItem=this.disabledItem.includes("disabled"),l.labelTag&&(l.typeTag=this.typeTag);let i=Object.assign({},l,{value:this.accordionItems.length});this.accordionItems=[...this.accordionItems,i],this.disabledItem=[],this.typeTag=void 0}changeLiterals(){try{this.customLiterals=JSON.parse(this.literals)}catch{this.customLiterals=void 0}}restore(){this.accordionItems=[],this.customLiterals=void 0,this.disabledItem=[],this.literals="",this.properties=[],this.propertiesAccordion=[],this.typeTag=void 0}static \u0275fac=function(i){return new(i||n)};static \u0275cmp=s({type:n,selectors:[["sample-po-accordion-labs"]],standalone:!1,decls:17,vars:13,consts:[["accordionForm",""],[3,"p-literals","p-show-manager-accordion","p-allow-expand-all-items"],[3,"p-label","p-disabled","p-label-tag","p-type-tag"],["p-label","ACCORDION"],[1,"po-row","po-mt-1","po-mb-1"],["name","literals","p-help",'Ex.: {"closeAllItems": "Fechar itens"}',"p-label","Literals",1,"po-md-6",3,"ngModelChange","p-change","ngModel"],["name","propertiesAccordion","p-label","Properties Accordion",1,"po-md-6",3,"ngModelChange","ngModel","p-options"],["p-label","ACCORDION ITEM"],[3,"p-fields","p-value"],[1,"po-row","po-mt-2","po-mb-2"],["p-label","Type Tag",1,"po-md-6",3,"ngModelChange","p-options","ngModel"],["p-label","Properties Accordion Item","name","disabledItem",1,"po-md-6",3,"ngModelChange","p-options","ngModel"],[1,"po-row","po-mt-1"],["p-label","Add Accordion",1,"po-md-6",3,"p-click","p-disabled"],[1,"po-row","po-mt-2"],["p-label","Sample Restore",1,"po-md-3",3,"p-click"]],template:function(i,a){if(i&1){let m=W();o(0,"po-accordion",1),z(1,ge,2,5,"po-accordion-item",2,H),e(),r(3,"po-divider",3),o(4,"div",4)(5,"po-input",5),_("ngModelChange",function(p){return b(m),k(a.literals,p)||(a.literals=p),g(p)}),u("p-change",function(){return b(m),g(a.changeLiterals())}),e(),o(6,"po-checkbox-group",6),_("ngModelChange",function(p){return b(m),k(a.propertiesAccordion,p)||(a.propertiesAccordion=p),g(p)}),e()(),r(7,"po-divider",7)(8,"po-dynamic-form",8,0),o(10,"div",9)(11,"po-radio-group",10),_("ngModelChange",function(p){return b(m),k(a.typeTag,p)||(a.typeTag=p),g(p)}),e(),o(12,"po-checkbox-group",11),_("ngModelChange",function(p){return b(m),k(a.disabledItem,p)||(a.disabledItem=p),g(p)}),e()(),o(13,"div",12)(14,"po-button",13),u("p-click",function(){b(m);let p=O(9);return a.addAccordionItem(p.form.value),g(p.form.reset())}),e()(),o(15,"div",14)(16,"po-button",15),u("p-click",function(){return b(m),g(a.restore())}),e()()}if(i&2){let m=O(9);c("p-literals",a.customLiterals)("p-show-manager-accordion",a.propertiesAccordion.includes("showManager"))("p-allow-expand-all-items",a.propertiesAccordion.includes("expandItems")),d(),R(a.accordionItems),d(4),T("ngModel",a.literals),d(),T("ngModel",a.propertiesAccordion),c("p-options",a.propertiesAccordionOptions),d(2),c("p-fields",a.accordionFieldsForm)("p-value",a.accordionItems),d(3),c("p-options",a.typeTagOptions),T("ngModel",a.typeTag),d(),c("p-options",a.disabledOption),T("ngModel",a.disabledItem),d(2),c("p-disabled",m.form.invalid)}},dependencies:[G,Y,P,S,X,K,te,Z,$,ee],encapsulation:2})}return n})();var Se=n=>({"docs-sample-code-tabs":n}),le=(()=>{class n{hideSampleCodeTabs=!0;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus"}static \u0275fac=function(i){return new(i||n)};static \u0275cmp=s({type:n,selectors:[["sample-po-accordion-labs-view"]],standalone:!1,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(i,a){i&1&&(r(0,"br"),o(1,"blockquote",0)(2,"label",1),t(3,"PO Accordion Labs"),e(),o(4,"a",2),u("click",function(){return a.toggleSampleCodeTabs()}),r(5,"span"),t(6),e()(),o(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),t(12,"sample-po-accordion-labs/sample-po-accordion-labs.component.html"),e(),o(13,"pre",7),t(14,`<po-accordion
